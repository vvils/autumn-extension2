          ...
          <div className="flex items-center">
            ...
            <div className="flex flex-1 items-center space-x-2">
              <input
                ...
                style={{
                  background: `linear-gradient(to right, ${isDarkMode ? '#3d828f' : '#70b5c2'} 0%, ${isDarkMode ? '#3d828f' : '#70b5c2'} ${(modelParameters[agentName].temperature / 2) * 100}%, ${isDarkMode ? '#475569' : '#cbd5e1'} ${(modelParameters[agentName].temperature / 2) * 100}%, ${isDarkMode ? '#475569' : '#cbd5e1'} 100%)`,
                }}
                className={`flex-1 ${isDarkMode ? 'accent-[#3d828f]' : 'accent-[#70b5c2]'} h-1 appearance-none rounded-full`}
              />
              <div className="flex items-center space-x-2">
                ...
                <input
                  ...
                  className={`w-20 rounded-md border ${isDarkMode ? 'border-slate-600 bg-slate-700 text-gray-200 focus:border-accent focus:ring-2 focus:ring-accent-foreground/50' : 'border-gray-300 bg-white text-gray-700 focus:border-accent-muted focus:ring-2 focus:ring-accent-light'} px-2 py-1 text-sm`}
            ...
            <div className="flex items-center">
              ...
              <div className="flex flex-1 items-center space-x-2">
                <input
                  ...
                  style={{
                    background: `linear-gradient(to right, ${isDarkMode ? '#3d828f' : '#70b5c2'} 0%, ${isDarkMode ? '#3d828f' : '#70b5c2'} ${modelParameters[agentName].topP * 100}%, ${isDarkMode ? '#475569' : '#cbd5e1'} ${modelParameters[agentName].topP * 100}%, ${isDarkMode ? '#475569' : '#cbd5e1'} 100%)`,
                  }}
                  className={`flex-1 ${isDarkMode ? 'accent-[#3d828f]' : 'accent-[#70b5c2]'} h-1 appearance-none rounded-full`}
                />
                <div className="flex items-center space-x-2">
              ...
              return (
                <div
                  ...
                  <div className="space-y-3">
                          ...
                          <input
                            ...
                            className={`flex-1 rounded-md border p-2 text-sm ${
                              nameErrors[providerId]
                                ...
                                : isDarkMode
                                  ? 'border-accent-hover bg-slate-700 text-gray-200 focus:border-accent focus:ring-2 focus:ring-accent-foreground/50'
                                  : 'border-accent-muted bg-gray-50 focus:border-accent-muted focus:ring-2 focus:ring-accent-light'
                            } outline-none`}
                          />
                        </div>
                        {nameErrors[providerId] ? (
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="relative flex-1">
                        <input
                          ...
                          className={`w-full rounded-md border text-sm ${isDarkMode ? 'border-slate-600 bg-slate-700 text-gray-200 focus:border-accent focus:ring-2 focus:ring-accent-foreground/50' : 'border-gray-300 bg-white text-gray-700 focus:border-accent-muted focus:ring-2 focus:ring-accent-light'} p-2 outline-none`}
                        />
                      ...
                      <div className="flex flex-col">
                        <div className="flex items-center">
                          ...
                          <input
                            ...
                            className={`flex-1 rounded-md border text-sm ${isDarkMode ? 'border-slate-600 bg-slate-700 text-gray-200 focus:border-accent focus:ring-2 focus:ring-accent-foreground/50' : 'border-gray-300 bg-white text-gray-700 focus:border-accent-muted focus:ring-2 focus:ring-accent-light'} p-2 outline-none`}
                          />
                        </div>
                      </div>
                    )}
                          ...
                          <div
                            ...
                            {(providerConfig.azureDeploymentNames || []).length > 0
                              ? (providerConfig.azureDeploymentNames || []).map((deploymentName: string) => (
                                  <div
                                    key={deploymentName}
                                    className={`flex items-center rounded-full ${isDarkMode ? 'bg-accent-foreground/30 text-accent-light' : 'bg-accent-soft text-accent-foreground'} px-2 py-1 text-sm`}>
                                    <span>{deploymentName}</span>
                                    <button
                                      type="button"
                                      onClick={() => removeAzureDeployment(providerId, deploymentName)}
                                      className={`ml-1 font-bold ${isDarkMode ? 'text-accent-muted hover:text-accent-light' : 'text-accent hover:text-accent-foreground'}`}
                    ...
                    {providerConfig.type === ProviderTypeEnum.Ollama && (
                      <div
                        className={`mt-4 rounded-md border ${isDarkMode ? 'border-slate-600 bg-slate-700' : 'border-gray-200 bg-gray-50'} p-3`}>
                        <p className={`text-sm ${isDarkMode ? 'text-gray-200' : 'text-gray-700'}`}>
                          <strong>
                            {' '}
                            <code
                              className={`rounded italic ${isDarkMode ? 'bg-slate-600 px-1 py-0.5' : 'bg-gray-100 px-1 py-0.5'}`}>
                          ...
                          <a
                            ...
                            className={`ml-1 ${isDarkMode ? 'text-accent-muted hover:text-accent-light' : 'text-accent hover:text-accent-foreground'}`}>
          ...
          <div className="provider-selector-container relative pt-4">
            <Button
              ...
              className={`flex w-full items-center justify-center font-medium ${
                isDarkMode
                  ? 'border-accent-hover bg-accent text-white hover:bg-accent-hover'
            ...
            {isProviderSelectorOpen && (
              <div
                className={`absolute z-10 mt-2 w-full overflow-hidden rounded-md border ${
                  isDarkMode
                    ? 'border-accent bg-slate-700 shadow-lg shadow-slate-900/50'
                    : 'border-gray-200 bg-white shadow-xl shadow-gray-100/50'
                }`}>
                <div className="py-1">
                    ...
                    .map(type => (
                      <button
                        ...
                        className={`flex w-full items-center px-4 py-3 text-left text-sm ${
                          isDarkMode
                            ? 'text-accent-light hover:bg-accent/30 hover:text-white'
